...
public class CustomMessegeAdapter extends BaseAdapter   implements OnClickListener {
     ...
     * @param map *****************/
    public CustomMessegeAdapter(Activity activity, List<SMSListItem> messageItems, List<String> mapKeyList, Map<String, List<SMSListItem>> map, Resources res) {
    ...
    private class OnItemLongClickListener  implements OnLongClickListener{           
					...
					case 1:
					    ...
					    .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
					        public void onClick(DialogInterface dialog, int which) { 
					        	dialog.cancel();
					        	deleteSMS(maiActivity, CustomMessegeAdapter.this, mSms.getId(), mSms.getAddress());
					        }
					     })
		...
		private void deleteSMS(Context context, CustomMessegeAdapter adapter, long mId, String mAddress) {
		    try {
